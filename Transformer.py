...
class TrnasformerBlock(nn.Module):
    def __init__(self, embed_size, heads, drouput, forward_expansion):
...
class Encoder(nn.Module):
    def __init__(
        ...
        self.position.embedding = nn.Embedding(max_length, embed_size)
...
class DecoderBlock(nn.Module):
    ...
    def forward(self, x, value, key, src_mask, try_mask):
